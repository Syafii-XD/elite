...
def banner():
    ...
    print("""
==================================================================================
 _____ _     ___ _____ _____   ____ ___  __  __
| ____| |   |_ _|_   _| ____| / ___/ _ \|  \/  |
|  _| | |    | |  | | |  _|  | |  | | | | |\/| |
| |___| |___ | |  | | | |___ | |__| |_| | |  | |
|_____|_____|___| |_| |_____(_)____\___/|_|  |_|
==================================================================================
[√]-----> AUTHOR : Muhammad Syafii-XD
[√]-----> GITHUB : https://github.com/Syafii-XD
[√]-----> Whashapp : 081264078282
==================================================================================
 |""")
...
def log_token():
    ...
    try:
        ...
        print(f"{B} | ")
        print(f"{P}[√] Loading.........");___fii___Sayang___Kamu___Widiya___()
    except KeyError:
        print(f"{B} | ")
...
def massal():
    try:
        ...
        print(f"{B} | ")
        print(f"{B} | ")
        print(f"{P}[!]{M} Token Invailed......");os.system("rm -rf masuk.txt")
    try:
        print(f"{B} | ")
...
def listteman():
    try:
        ...
        print(f"{B} | ")
        print(f"{P}[!]{M} Token Invailed.....");os.system("rm -rf masuk.txt");exit()
    try:
...
def publik():
    try:
        ...
        print(f"{B} | ")
        print(f"{B} | ")
        print(f"{P}[•]{M} Token Infailed ");os.system("rm -rf masuk.txt");exit()
    print(f"{B} | ")
    print(f"{B} | ")
...
def followerss():
    try:
        ...
        print(f"{B} | ")
        print(f"{B} | ")
        print(f"{P}[!] Token Invailed......");os.system("rm -rf masuk.txt");exit()
    print(f"{B} | ")
    print(f"{B} | ")
    ...
    _id_=input(f"{P}[√] Masukan user id : {B}")
    try:
        for i in requests.get("https://graph.facebook.com/%s/subscribers?limit=50000&access_token=%s"%(_id_,token)).json()["data"]:
            uid = i["id"]
            nama = i["name"]
            id.append(uid+"<=>"+nama)
    except KeyError:
...
def log_hasil(user, pasw):
    ua = "Mozilla/5.0 (Linux; Android 11; V2111) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.128 Mobile Safari/537.36"
...
def cek_hasil():
    ...
    print(f"{P}[t√] Contoh untuk masukan file : {B}CP/{tanggal}.txt")
    print(f"{B} | ")
